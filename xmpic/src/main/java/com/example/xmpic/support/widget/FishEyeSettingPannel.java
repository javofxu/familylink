package com.example.xmpic.support.widget;
...
public class FishEyeSettingPannel extends LinearLayout{
    ...
    private void initView(Context context){
        ...
        addView(imageView_qiu, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        imageView_fangkuai = new ImageView(context);
        imageView_fangkuai.setImageDrawable(getResources().getDrawable(R.mipmap.fangkuai));
        addView(imageView_fangkuai, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        imageView_banyuan1 = new ImageView(context);
        imageView_banyuan1.setImageDrawable(getResources().getDrawable(R.mipmap.bantuoyuan));
        addView(imageView_banyuan1, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        ...
        addView(imageView_banyuan2, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        ...
        addView(imageView_radius_fangkuai, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        imageView_duoping = new ImageView(context);
        imageView_duoping.setImageDrawable(getResources().getDrawable(R.mipmap.duoping));
        addView(imageView_duoping, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        imageView_shangxia = new ImageView(context);
        imageView_shangxia.setImageDrawable(getResources().getDrawable(R.mipmap.shangxia));
        addView(imageView_shangxia, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
    }
