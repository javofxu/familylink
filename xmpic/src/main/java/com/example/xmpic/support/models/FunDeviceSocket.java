package com.example.xmpic.support.models;

import com.example.xmpic.support.config.BaseConfig;
import com.example.xmpic.support.config.OPPowerSocketGet;
import com.example.xmpic.support.config.PowerSocketArm;
import com.example.xmpic.support.config.PowerSocketAutoLight;
import com.example.xmpic.support.config.PowerSocketAutoSwitch;
import com.example.xmpic.support.config.PowerSocketAutoUsb;
import com.example.xmpic.support.config.PowerSocketBanLed;
import com.example.xmpic.support.config.PowerSocketDelayLight;
import com.example.xmpic.support.config.PowerSocketDelaySwitch;
import com.example.xmpic.support.config.PowerSocketDelayUsbPower;
import com.example.xmpic.support.config.PowerSocketImage;
import com.example.xmpic.support.config.PowerSocketSensitive;
import com.example.xmpic.support.config.PowerSocketWorkRecord;
