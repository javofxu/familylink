...
public class LocalVideoAdapter$ItemHolder_ViewBinding implements Unbinder {
  private LocalVideoAdapter.ItemHolder target;

  @UiThread
  public LocalVideoAdapter$ItemHolder_ViewBinding(LocalVideoAdapter.ItemHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LocalVideoAdapter.ItemHolder target = this.target;
