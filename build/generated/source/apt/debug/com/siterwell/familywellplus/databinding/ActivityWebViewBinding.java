...
public class ActivityWebViewBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_web_view_back, 1);
        sViewsWithIds.put(R.id.web_view, 2);
    }
    // views
    @NonNull
    public final android.widget.ImageView ivWebViewBack;
    @NonNull
    ...
    public ActivityWebViewBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivWebViewBack = (android.widget.ImageView) bindings[1];
        this.mboundView0 = (android.widget.LinearLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.webView = (android.webkit.WebView) bindings[2];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityWebViewBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityWebViewBinding>inflate(inflater, com.siterwell.familywellplus.R.layout.activity_web_view, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityWebViewBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.siterwell.familywellplus.R.layout.activity_web_view, null, false), bindingComponent);
    }
    @NonNull
