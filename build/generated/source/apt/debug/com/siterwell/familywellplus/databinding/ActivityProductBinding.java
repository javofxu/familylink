...
public class ActivityProductBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_product_back, 1);
        sViewsWithIds.put(R.id.rv_product, 2);
    }
    // views
    @NonNull
    public final android.widget.ImageView ivProductBack;
    @NonNull
    private final android.widget.LinearLayout mboundView0;
    @NonNull
    public final android.support.v7.widget.RecyclerView rvProduct;
    // variables
    // values
    // listeners
    ...
    public ActivityProductBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivProductBack = (android.widget.ImageView) bindings[1];
        this.mboundView0 = (android.widget.LinearLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.rvProduct = (android.support.v7.widget.RecyclerView) bindings[2];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ActivityProductBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityProductBinding>inflate(inflater, com.siterwell.familywellplus.R.layout.activity_product, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityProductBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.siterwell.familywellplus.R.layout.activity_product, null, false), bindingComponent);
    }
    @NonNull
