...
public class ActivityGatewaySettingBinding extends android.databinding.ViewDataBinding  {
    ...
    public ActivityGatewaySettingBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    @NonNull
    public static ActivityGatewaySettingBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGatewaySettingBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityGatewaySettingBinding>inflate(inflater, com.siterwell.familywellplus.R.layout.activity_gateway_setting, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static ActivityGatewaySettingBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGatewaySettingBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.siterwell.familywellplus.R.layout.activity_gateway_setting, null, false), bindingComponent);
    }
    @NonNull
    public static ActivityGatewaySettingBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGatewaySettingBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/activity_gateway_setting_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ActivityGatewaySettingBinding(bindingComponent, view);
    }
    /* flag mapping
        flag 0 (0x1L): null
    flag mapping end*/
