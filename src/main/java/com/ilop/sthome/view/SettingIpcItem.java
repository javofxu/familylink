...
public class SettingIpcItem extends RelativeLayout {
    ...
    public SettingIpcItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.item_ipc_setting, this, true);
        ...
        spinner = findViewById(R.id.spinnerCameraDefinition);
        seekBar = findViewById(R.id.setupRecordPreSeekbar);
