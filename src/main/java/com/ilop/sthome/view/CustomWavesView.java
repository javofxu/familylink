...
public class CustomWavesView extends View {
    ...
    public CustomWavesView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initBitmap(context);
    ...
    private void initBitmap(Context context) {
        ...
        mXOffsetSpeedOne = DisplayUtils.dip2px(context, TRANSLATE_X_SPEED_ONE);
        mXOffsetSpeedTwo = DisplayUtils.dip2px(context, TRANSLATE_X_SPEED_TWO);
