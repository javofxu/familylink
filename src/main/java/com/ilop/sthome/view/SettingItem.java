...
public class SettingItem extends RelativeLayout {
    ...
    public SettingItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.item_detail_list, this, true);

        mContent = findViewById(R.id.line_bg);
        ...
        switchbox = findViewById(R.id.checkbox);
        checkstatusimage = findViewById(R.id.checkstatus);
        TypedArray localTypedArray = context.obtainStyledAttributes(attrs, R.styleable.setting_info);
        setBackground(localTypedArray.getBoolean(R.styleable.setting_info_item_background, true));
    ...
    public void setBackground(boolean background){
        if (background) {
            mContent.setBackgroundResource(R.drawable.item_selector);
        }
    }
    /**
     * 设置标题信息
...
//    }
    ...
    private void setAccessoryType(int accessoryType) {
        if(accessoryType == ACCESSORY_TYPE_ARROW) {
            ...
            mCheckedTextView.setImageResource(R.mipmap.arrow);
