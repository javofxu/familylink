...
public class SiterSDK {
    ...
    public static String SETTINGS_CONFIG_PRIVACY_AGREE = "com.siterwell.sthome.privacy.agreement";
    ...
    private static void initAppInfo(String json) {
        try {
            if (!TextUtils.isEmpty(json)) {
                ...
                CacheUtil.putString(SETTINGS_CONFIG_PRIVACY_AGREE, jsonConfig.getJSONObject("privacy_agreement").toString());
            } else {
