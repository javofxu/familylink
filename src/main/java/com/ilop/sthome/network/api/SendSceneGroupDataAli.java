 ...
 */
public class SendSceneGroupDataAli {
    private Context context;
    private SendCommandAli sc;
    private static final String TAG = "SendSceneGroupDataAli";
    private DeviceInfoBean deviceInfoBean;


    public SendSceneGroupDataAli(Context context, DeviceInfoBean deviceInfoBean) {
...
//        初始化
     ...
     * @param sceneGroupid
     */
    public void deleteSceneGroup(final int sceneGroupid){
