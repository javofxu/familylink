...
public class ResetSelectorDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText(getResources().getString(R.string.account_choose_find_pwd_style));
        ...
        btnPhone.setText(getResources().getString(R.string.phone_find));
        btnPhone.setOnClickListener(onClickListener);
        TextView btnMail = view.findViewById(R.id.btn_register_email);
        btnMail.setText(getResources().getString(R.string.email_find));
