 ...
 * description：GAS报警器详情页
 */
public class GasDetailActivity extends BaseDetailActivity<ActivityDetailAlarmBinding>  {
    ...
    protected void initListener() {
        super.initListener();
        mDBind.operation.setOnClickListener(v -> {
    ...
    protected void onResume() {
        ...
        if(mDevice == null){
            ...
            if(TextUtils.isEmpty(mDevice.getSubdeviceName())){
                mDBind.detailName.setText(getString(R.string.gasalarm) + mDevice.getDevice_ID());
            }else{
                mDBind.detailName.setText(mDevice.getSubdeviceName());
            }
            mDBind.detailIcon.setImageResource(R.mipmap.gs870w);
        }
    }
