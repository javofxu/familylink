...
public class EmailRegisterAliActivity extends EmailRegisterActivity {
    ...
    protected String getLayoutName() {
        return "activity_mail_register_ali";
    }

    private void initView() {
        this.mToolBar.setVisibility(View.GONE);
        this.emailCodeInputBox.getSend().setText(getResources().getString(R.string.get_code));
        this.emailCodeInputBox.setSendText("get_code");
    ...
    private void initData() {
        ...
        RxTimerUtil.interval(1000, number -> this.sendEmailButton.setEnabled(isAgree));
    }
    ...
    private void initListener(){
        ...
        mCheckBox.setOnCheckedChangeListener((compoundButton, b) -> {
            isAgree = b;
            this.sendEmailButton.setEnabled(b);
        });
    }
    ...
    private void setMsg(String content, TextView textView) {
        ...
        builder.setSpan(new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Intent intent = new Intent();
                intent.setClass(EmailRegisterAliActivity.this, WebViewActivity.class);
