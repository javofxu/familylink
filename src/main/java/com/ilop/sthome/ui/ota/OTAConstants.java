package com.ilop.sthome.ui.ota;
...
public class OTAConstants {
    ...
    public static final String APICLIENT_PATH_QUERYDEVICEDETAIL = "/thing/info/get";
    ...
    public static final int MINE_MESSAGE_RESPONSE_OTA_DEVICE_DETAIL_INFO_SUCCESS = 0x11006;
    public static final int MINE_MESSAGE_RESPONSE_OTA_DEVICE_DETAIL_INFO_FAILED = 0x21006;
    ...
    public static final String MINE_URL_OTA = "https://com.siterwell.familywellplus/page/ota";
}
