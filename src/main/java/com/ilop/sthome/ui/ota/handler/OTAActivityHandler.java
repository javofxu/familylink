...
import com.ilop.sthome.ui.ota.activity.OTAActivity;
...
public class OTAActivityHandler extends Handler {
    ...
    public static boolean isNetworkAvalible(Context context) {
        ...
        if (connectivityManager == null) {
            ...
            return net_info != null && net_info.isConnected();
        }
    }
    ...
    public void handleMessage(Message msg) {
        ...
        if (OTAConstants.MINE_MESSAGE_RESPONSE_OTA_DEVICE_INFO_SUCCESS == msg.what) {
            ...
            //请求失败(产品详情获取、设备详情获取)
            if(OTAConstants.MINE_MESSAGE_RESPONSE_OTA_DEVICE_INFO_FAILED == msg.what){
                mBusiness.requestDeviceDetailInfo(mSimpleInfo.iotId);
            }else {
                mIActivity.showLoaded(null);
            ...
            if (null != msg.obj) {
                ...
                mIActivity.showCurrentVersionNoNeedToupdate(current);
            }

        } else if(OTAConstants.MINE_MESSAGE_RESPONSE_OTA_DEVICE_DETAIL_INFO_FAILED==msg.what) {
            mIActivity.showLoaded(null);
            mIActivity.showLoadError();
        }
