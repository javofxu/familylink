...
import com.ilop.sthome.utils.ImageLoaderUtil;
 ...
 */
public class LocalPicAdapter extends RecyclerView.Adapter<LocalPicAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemHolder viewHolder, int i) {
        ...
        ImageLoaderUtil.getInstance(3, ImageLoaderUtil.Type.LIFO).loadImage(eq.getFilepath(), viewHolder.imageView);
        ...
        viewHolder.itemView.setOnClickListener(view -> {
            LiveDataBus.get().with("local_pic_adapter").setValue(eq);
        });
    }
