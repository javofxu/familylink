...
import com.ilop.sthome.data.event.EventProgress;
	...
	private final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWN_OK:
				...
				eventProgress2.setUpdateprogress(100);
				EventBus.getDefault().post(eventProgress2);
				break;
			...
			case DOWN_ERROR:
				...
				case DOWN_ING:
                 int progres  = (int)msg.obj;
					...
					eventProgress.setUpdateprogress(progres);
