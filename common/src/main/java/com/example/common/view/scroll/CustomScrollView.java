package com.example.common.view.scroll;
 ...
 * @Author skygge.
 * @Date on 2019-10-10.
 * @Dec: 解决ScrollView嵌套Banner于RecyclerView滑动冲突解决
 */
public class CustomScrollView extends LinearLayout {
    ...
    private int mHeadHeight = 0;        //滑出头部的高度
    ...
    public CustomScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        topOffset = a.getDimensionPixelSize(R.styleable.CustomScrollView_top_offset, topOffset);
        mHeadHeight = a.getDimensionPixelSize(R.styleable.CustomScrollView_top_viewHeight, mHeadHeight);
        a.recycle();
    ...
    public void setTopViewHeight(int hight) {
        this.mHeadHeight = hight;
    }
