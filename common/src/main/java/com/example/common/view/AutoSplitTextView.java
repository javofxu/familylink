...
public class AutoSplitTextView extends View {
    ...
    private void initAttr(Context context,AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AutoSplitTextView);
        mPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.AutoSplitTextView_paddingLeft, 0);
        mPaddingRight = typedArray.getDimensionPixelSize(R.styleable.AutoSplitTextView_paddingRight, 0);
        mPaddingTop = typedArray.getDimensionPixelSize(R.styleable.AutoSplitTextView_paddingTop, 0);
        mPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.AutoSplitTextView_paddingBottom, 0);

        mText = typedArray.getString(R.styleable.AutoSplitTextView_text);
        textColor = typedArray.getString(R.styleable.AutoSplitTextView_text_Color);
        if(textColor==null){
            textColor="#000000";
        }
        textSize = typedArray.getDimensionPixelSize(R.styleable.AutoSplitTextView_text_Size, 50);
        lineSpace = typedArray.getInteger(R.styleable.AutoSplitTextView_line_Spacing, 0);
        typedArray.recycle();
    }
