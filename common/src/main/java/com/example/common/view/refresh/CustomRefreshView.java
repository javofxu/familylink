...
public class CustomRefreshView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mLayoutManager instanceof LinearLayoutManager) {
                    firstVisiblePosition = ((LinearLayoutManager) mLayoutManager).findFirstCompletelyVisibleItemPosition();
    ...
    public void setEmptyView(String s, int img) {
        ...
        if (mEmptyView == null) {
            ...
            mEmptyImg.setOnClickListener(v -> mEmptyListener.onClick());
        }
    ...
    public void setErrorView() {
        ...
        if (mErrorView == null) {
            ...
            mErrorView.findViewById(R.id.module_base_id_fail_retry).setOnClickListener(v -> {
                //重试
                setRefreshing(true);
            });
        }
