...
public class HeaderScrollHelper {
    ...
    public boolean isTop() {
        ...
        if (scrollableView instanceof LinearLayout) {
            return isLinearViewTop((LinearLayout) scrollableView);
        }
    ...
    private boolean isLinearViewTop(LinearLayout linearLayout) {
        if (linearLayout != null) {
            int linearLayoutY = linearLayout.getScrollY();
            return linearLayoutY <= 0;
        }
        return false;
    }
