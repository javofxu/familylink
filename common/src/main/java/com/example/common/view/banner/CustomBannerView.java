...
public class CustomBannerView<T> extends RelativeLayout {
    ...
    private int []mIndicatorRes= new int[]{R.drawable.radio_select_normal,R.drawable.radio_select};
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link CustomBannerView {@link #(List, HolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
